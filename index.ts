...
import { thridLargestElement } from "./src/basic/justdo/thirdLargestElement.ts";

// pattern creation
import { squre } from "./src/pattern-creation/squre.ts";
import { RightTriangle } from "./src/pattern-creation/RightTriangle.ts";
import { RightTriangleNum } from "./src/pattern-creation/RightTriangleNum.ts";
import { reverseString } from "./src/basic/Level-3/reverseString.ts";
...
// console.log("moving number is running");
// console.log(missingNumber([0,1,2,3,4,5,6,7]));
// console.log(thridLargestElement([1,0,3,4]));
// console.log(squre())
// console.log(RightTriangle());
// console.log(RightTriangleNum());
